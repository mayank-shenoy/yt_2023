...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_2yt_9utilities_3lib_8bitarray_bitarray = __Pyx_ImportType_0_29_36(__pyx_t_1, "yt.utilities.lib.bitarray", "bitarray", sizeof(struct __pyx_obj_2yt_9utilities_3lib_8bitarray_bitarray), __PYX_GET_STRUCT_ALIGNMENT_0_29_36(struct __pyx_obj_2yt_9utilities_3lib_8bitarray_bitarray),__Pyx_ImportType_CheckSize_Warn_0_29_36); if (!__pyx_ptype_2yt_9utilities_3lib_8bitarray_bitarray) __PYX_ERR(4, 28, __pyx_L1_error)
  __pyx_vtabptr_2yt_9utilities_3lib_8bitarray_bitarray = (struct __pyx_vtabstruct_2yt_9utilities_3lib_8bitarray_bitarray*)__Pyx_GetVtable(__pyx_ptype_2yt_9utilities_3lib_8bitarray_bitarray->tp_dict); if (unlikely(!__pyx_vtabptr_2yt_9utilities_3lib_8bitarray_bitarray)) __PYX_ERR(4, 28, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
